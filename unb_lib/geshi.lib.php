...
class GeSHi
{
	...
	/**
     * Line number classname
     * @var string
     */
	var $line_class1 = '';

    /**
     * Line number classname for fancy lines
     * @var string
     */
	var $line_class2 = '';
	...
	/**
	 * Sets the classes for the line numbers.
     *
     * @param string The classname for the line numbers that are "normal"
     * @param string If a string, this is the classname of the line
     *        numbers that are "fancy"
     * @since 1.0.7.5
	 */
	function set_line_class ($class1, $class2 = '')
	{
		$this->line_class1 = $class1;
		$this->line_class2 = $class2;
	}
